...
from Utils.loss import Decomposition_Consistency_Loss
...
class Trainer(object):
    ...
    def train(self):
        ...
        self.model.train()
        for iteration, (images, targets, contours) in enumerate(self.train_loader):
            ...
            #loss_dc = self.loss_dc(fake, contours)
    ...
    def validation(self):
        ...
        model.eval()
        for i, (image, target,contours) in enumerate(self.val_loader):
